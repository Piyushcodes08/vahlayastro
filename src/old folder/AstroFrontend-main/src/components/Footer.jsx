  ...
  return (
    <footer className="relative bg-red-600 text-white py-6 px-4">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://res.cloudinary.com/dzdnwpocf/image/upload/v1753466271/footer_BG_iqesem.png')",
      ...
      <div className="relative z-10">
        ...
        <div className="hidden md:block">
          ...
          <div className="flex justify-center space-x-4 mt-10">
            <a
              href="https://www.facebook.com/astrovahlay09/"
              target="_blank"
            ...
            <a
              href="https://x.com/astrovahlay09"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-orange-300 transition"
            >
            ...
            <a
              href="https://www.instagram.com/astrovahlay09/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-orange-300 transition"
            >
            ...
            <a
              href="https://www.youtube.com/channel/UCqp0IMTSGq8TFHmG3XiAtQQ"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-orange-300 transition"
            >
