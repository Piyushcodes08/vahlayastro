        ...
        <div className="flex">
            ...
            <div className="p-8">
                <h2 className="text-2xl font-semibold mb-4 text-red-600">
                    Meetings for Course: {courseName}
                </h2>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        Date: {new Date(m.startDate).toLocaleString()}
                                    </p>
                                </div>
                                <div>
                                    {m.ringCentralMeeting?.roomUrl && (
                                        <button
                                            onClick={() =>
                                                handleOpenPopup(m.ringCentralMeeting.roomUrl)
                                            }
                ...
                {showIframe && (
                    <div
                        className={`z-50 ${
                            isFullscreen ? 'fixed top-0 left-0 w-screen h-screen' : 'fixed inset-0'
                        } pointer-events-auto`}
