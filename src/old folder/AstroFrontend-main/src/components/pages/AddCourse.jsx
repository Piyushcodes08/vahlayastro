        ...
        {isFormVisible && (
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">SEO Title</label>
                <input type="text" className="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-600" value={seoTitle} onChange={(e) => setSeoTitle(e.target.value)} placeholder="Enter SEO Title" />
              </div>
              <div>
                <label className="block text-gray-700 font-semibold mb-2">SEO Description</label>
                <input type="text" className="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-600" value={seoDescription} onChange={(e) => setSeoDescription(e.target.value)} placeholder="Enter SEO Description" />
              </div>
              <div>
                <label className="block text-gray-700 font-semibold mb-2">SEO Keywords (comma separated)</label>
                <input type="text" className="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-600" value={seoKeywords} onChange={(e) => setSeoKeywords(e.target.value)} placeholder="e.g. astrology, horoscope, zodiac" />
              </div>
              {courseType === "paid" && (
                <div>
