...
const Home = () => {
  ...
  return (
    ...
    <section className="relative mb-2 text-sm">
  ...
  <div className="relative h-[90vh] md:h-screen w-full overflow-hidden">
    ...
    <video
      ...
      src="https://cdn.pixabay.com/video/2024/02/04/199293-909903179_large.mp4"
    />

    {/* STRONG OVERLAY (FIX VISIBILITY) */}
    <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/20 to-black/20"></div>

    {/* EXTRA CENTER FOCUS OVERLAY */}
      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold leading-tight text-white"
          >
            Discover Your{" "}
            <span className="bg-gradient-to-r from-orange-100 via-red-400 to-red-600 bg-clip-text text-transparent">
              Cosmic Destiny
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="mt-6 text-base sm:text-lg md:text-xl text-white/90 leading-relaxed"
          >
            Get deep insights into your life through astrology, personalized
            consultation, and expert knowledge crafted for your journey.
          </motion.p>
          ...
          >
            ...
            <Link
              ...
              bg-gradient-to-r from-orange-100 via-red-400 to-red-600 
            ...
            <Link
              to="/courses"
              className="flex items-center gap-2 border border-white/50 
          ...
          <div className="h-[600px] overflow-hidden relative">
            <div className="animate-scroll-slow flex flex-col space-y-6">
              {[...testimonials, ...testimonials].map((testimonial, index) => (
                ...
                >
                  <p
                    className={`text-xs lg:text-sm ${index % 2 === 0
                        ? "text-white"
                  ...
                  <div className="flex flex-row items-center">
                    <div>
                      <h3
                        className={`text-xl lg:text-2xl font-semibold ${index % 2 === 0
                            ? "text-white"
                      ...
                      <p
                        className={`text-xs lg:text-sm mb-2 ${index % 2 === 0
                            ? "text-white"
                ...
                >
                  {[...col, ...col].map((testimonial, index) => (
                    ...
                    >
                      ...
                      <div
                        className={`flex justify-start   gap-1 ${index % 2 === 0
                            ? "text-yellow-300"
                            : "text-yellow-500"
                          } mb-4`}
                      >
                      ...
                      <div className="flex flex-row items-center">
                        <div>
                          <h3
                            className={`text-xl font-semibold ${index % 2 === 0
                                ? "text-white"
                                : "text-gray-800 dark:text-white"
                              }`}
                          >
