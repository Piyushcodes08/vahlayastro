          ...
          {formVisible && (
            ...
            >
              ...
              <div>
                ...
                <textarea
                  value={formState.sTitle}
                  onChange={(e) =>
                    setFormState({ ...formState, sTitle: e.target.value })
                  }
                  className="w-full p-2 border rounded"
                />
              </div>
                ...
                <textarea
                  value={formState.sDesc}
                  onChange={(e) =>
                    setFormState({ ...formState, sDesc: e.target.value })
                  }
                  className="w-full p-2 border rounded"
                />
              </div>
              <div>
                <label className="block font-medium">SEO Keywords  (comma separated)</label>
                <textarea
                  value={formState.sKeywords}
                  onChange={(e) =>
                    setFormState({ ...formState, sKeywords: e.target.value })
                  }
                  className="w-full p-2 border rounded"
                />
              </div>
