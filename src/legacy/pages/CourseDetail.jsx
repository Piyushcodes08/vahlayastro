  ...
  return (
    <div className="text-white selection:bg-[#dd2727]/80 font-poppins bg-transparent">
      ...
      <section className="relative flex items-center pt-20 pb-8 overflow-hidden hero-section">
        ...
        <div className="relative z-10 section-container !pt-0 !pb-0">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-20">
            ...
            >
              {/* Red Pill Label */}
              <div className="inline-block px-4 py-1 rounded-full border border-[#dd2727]/30 bg-[#dd2727]/5 mb-1 self-center lg:self-start">
            ...
            >
              ...
              <div className="w-full group">
                <Link to={enrollUrl}>
                  <button className="w-full py-3.5 rounded-lg bg-[#dd2727] text-white font-black uppercase tracking-[0.3em] text-[11px] shadow-2xl hover:bg-white hover:text-[#dd2727] transition-all duration-500 transform hover:-translate-y-1 relative overflow-hidden">
          ...
          <aside className="lg:w-[450px]">
            <div className="sticky top-32 space-y-8">
              ...
              <div className="relative rounded-xl overflow-hidden border border-white/10 group h-[300px]">
                <img src="/src/assets/images/common/team/hansal sir.jpg" alt="Acharya Hansal" loading="lazy" className="w-full h-full object-cover opacity-80 group-hover:scale-110 transition-transform duration-1000" />
      ...
      <section className="py-8 w-full">
        <div className="w-full max-w-[1170px] mx-auto px-[15px] space-y-6">
          <div className="flex items-center justify-between border-b border-white/5 pb-4">
            <h3 className="title-batangas text-2xl md:text-3xl">Sacred <span className="text-[#dd2727]">Modules</span></h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              <motion.div
                ...
                className="p-4 rounded-lg bg-white/[0.03] backdrop-blur-xl border border-white/10 flex flex-col justify-between group hover:bg-white/[0.07] transition-all duration-400 hover:-translate-y-1 relative overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-[#dd2727]/10 to-transparent rounded-full blur-lg -mr-4 -mt-4 group-hover:scale-150 transition-transform"></div>
                ...
                <div className="flex items-center gap-2 relative z-10">
                  <span className="text-[9px] font-black text-[#dd2727] uppercase tracking-widest">Module 0{i + 1}</span>
      ...
      <section className="py-8 relative overflow-hidden">
        ...
        <div className="premium-container relative z-10">
          <div className="text-center mb-10">
            <h2 className="title-batangas text-3xl md:text-5xl mb-4">Is This <span className="text-[#dd2727]">For You?</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                key={i}
                whileHover={{ y: -12 }}
                className="p-8 rounded-xl bg-black/40 backdrop-blur-2xl border border-white/10 text-center hover:bg-white/[0.05] hover:border-[#dd2727]/30 transition-all duration-500 group shadow-2xl relative overflow-hidden"
              >
                ...
                <div className="w-16 h-16 rounded-lg bg-white/[0.03] border border-white/5 flex items-center justify-center text-[#dd2727] text-3xl mx-auto mb-6 group-hover:scale-110 group-hover:bg-[#dd2727]/10 transition-all duration-500 shadow-inner">
                  {item.i}
                </div>
                <h4 className="title-batangas text-2xl mb-4 group-hover:text-[#dd2727] transition-colors">{item.t}</h4>
      ...
      <section className="py-8">
        <div className="premium-container flex flex-col md:flex-row items-center gap-10 bg-black/40 backdrop-blur-2xl rounded-2xl border border-white/10 p-8 md:p-12 overflow-hidden relative shadow-2xl">
          ...
          <div className="flex-1 space-y-4 relative z-10 text-center md:text-left">
            <div className="inline-block px-3 py-1 rounded-full border border-[#dd2727]/30 bg-[#dd2727]/5">
              <span className="text-[#dd2727] text-[9px] font-black uppercase tracking-widest">Official Credentials</span>
            </div>
            <h2 className="title-batangas text-3xl md:text-5xl text-white">Verified <br /><span className="text-[#dd2727]">Certification</span></h2>
          ...
          <div className="flex-1 relative z-10 w-full max-w-[450px]">
            <div className="aspect-[1.4/1] bg-white/5 backdrop-blur-xl border border-white/10 rounded-lg shadow-2xl p-4 md:p-6 relative transform rotate-2 hover:rotate-0 transition-transform duration-700">
              <div className="w-full h-full border border-[#dd2727]/20 rounded flex flex-col items-center justify-center gap-2 text-center p-4">
                <div className="w-12 h-12 rounded-full bg-[#dd2727]/10 flex items-center justify-center text-2xl">𓁿</div>
                <h3 className="title-batangas text-lg">Certificate of Completion</h3>
                <div className="w-16 h-[1px] bg-[#dd2727]/40"></div>
                <p className="text-[9px] text-white/40 uppercase tracking-[0.2em]">Awarded to</p>
                <p className="font-bold text-sm text-white tracking-widest">[Your Name Here]</p>
                <div className="mt-4 pt-4 border-t border-white/10 w-full flex justify-between">
                  <div className="text-[7px] text-white/20 uppercase">Signature</div>
                  <div className="text-[7px] text-white/20 uppercase italic">Acharya Hansal</div>
                </div>
              </div>
              <div className="absolute top-3 right-3 text-[#dd2727] opacity-20 text-3xl">✦</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-transparent relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <div className="text-center mb-10">
            <h2 className="title-batangas text-3xl md:text-5xl text-white">Essential <span className="text-[#dd2727]">Inquiries</span></h2>
