        ...
        <>
            ...
            <main className="min-h-screen relative z-10 text-white overflow-hidden bg-transparent">
                ...
                <section className="hero-section">
                    <div className="section-container">
                        <div className="relative z-10 max-w-4xl mx-auto text-center">
                            ...
                            <h1 className="title-batangas text-5xl md:text-7xl mb-6 leading-tight text-white">
                                Empower Your Life with <span className="text-[#dd2727]">Vahlay Astro</span>
                            </h1>
                            ...
                            <div className="flex flex-wrap justify-center gap-8 mt-16">
                                {[
                                    ...
                                    <div key={i} className="text-center">
                                        <div className="title-batangas text-3xl md:text-4xl font-bold text-[#dd2727]">
                                            {s.num}
                                        </div>
                ...
                <section id="services">
                    <div className="section-container">
                        <div className="text-center mb-14">
                            <span className="inline-block px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-[0.2em] mb-4 border border-[#dd2727]/30 bg-[#dd2727]/10 text-[#ff6b6b]">
                                What We Offer
                            </span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                            {consultServices.map((srv, i) => (
                                ...
                                >
                                    {/* Image Area - Show full image without cropping */}
                                    <div className="w-full relative bg-[#080101]/40 flex items-center justify-center">
                                        <img
                                            src={srv.img}
                                            alt={srv.title}
                                        ...
                                        <span className="absolute top-5 left-5 text-3xl drop-shadow-lg z-10">{srv.icon}</span>
                                    </div>

                                    {/* Content */}
                                    <div className="p-7 flex flex-col flex-1">
                                        <h3 className={`title-batangas text-xl mb-3 transition-colors duration-300 ${activeCard === i ? 'text-[#ff6b6b]' : 'text-[#dd2727]'}`}>
                                            {srv.title}
                                        </h3>
                                        ...
                                        <Link
                                            to="/appointment"
                                            className="mt-6 inline-block font-bold text-sm uppercase tracking-wider transition-all duration-300 text-[#dd2727] hover:text-white"
                                        >
                                            Book An Appointment →
                                        </Link>
                                    </div>
                ...
                <section>
                    <div className="section-container">
                        <div
                            className="rounded-[2.5rem] p-12 relative overflow-hidden bg-white/5 border border-white/10 backdrop-blur-xl"
                        >
                            {/* BG glow */}
                            <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_at_center,rgba(221,39,39,0.08)_0%,transparent_70%)]" />
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                                    {processSteps.map((step, i) => (
                                        <div key={i} className="text-center group">
                                            <div
                                                className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5 transition-all duration-300 group-hover:scale-110 bg-gradient-to-br from-[#dd2727]/30 to-[#dd2727]/10 border border-[#dd2727]/40 shadow-[0_0_20px_rgba(221,39,39,0.2)]"
                                            >
                                                <span className="title-batangas text-xl font-bold text-[#dd2727]">
                                                    {step.step}
                                                </span>
                                            </div>
                        ...
                        <div className="section-container">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                {testimonials.map((t, i) => (
                                    <div
                                        key={t.id || i}
                                        className="rounded-[2rem] p-8 flex flex-col transition-all duration-500 hover:-translate-y-2 bg-white/5 border border-white/10 backdrop-blur-xl shadow-xl"
                                    >
                                        <div className="text-3xl mb-4 text-[#dd2727]">"</div>
                                        ...
                                        <div className="mt-6 flex items-center gap-3">
                                            <div
                                                className="w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm bg-gradient-to-br from-[#dd2727] to-[#a01818]"
                                            >
                ...
                <section>
                    <div className="section-container">
                        <div className="rounded-[2.5rem] overflow-hidden relative border border-[#dd2727]/20 shadow-[0_20px_70px_rgba(221,39,39,0.15)]">
                            <img
                                src="/src/assets/img/consulting.webp"
                                alt="Consulting"
                                className="w-full h-[400px] md:h-[520px] object-cover object-center"
                            />
                            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8 bg-gradient-to-t from-black/85 via-black/40 to-transparent">
                                <h2 className="title-batangas text-4xl md:text-6xl text-white mb-4 drop-shadow-[0_4px_30px_rgba(0,0,0,0.8)]">
                                ...
                                <Link
                                    to="/appointment"
                                    className="inline-block px-12 py-4 rounded-full font-bold uppercase tracking-wider transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(221,39,39,0.6)] bg-gradient-to-br from-[#dd2727] to-[#a01818] shadow-[0_8px_30px_rgba(221,39,39,0.4)] text-white"
                                >
                                    Schedule a Session
                                </Link>
                            </div>
                ...
                <section>
                    <div className="section-container">
                        <div className="rounded-[2rem] p-12 text-center bg-white/5 border border-[#dd2727]/25 backdrop-blur-2xl shadow-[0_15px_60px_rgba(221,39,39,0.2)]">
                            ...
                            <div className="flex flex-wrap gap-4 justify-center">
                                <Link
                                    to="/appointment"
                                    className="inline-block px-10 py-4 rounded-full font-bold uppercase tracking-wider text-white transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_50px_rgba(221,39,39,0.5)] bg-gradient-to-br from-[#dd2727] to-[#a01818] shadow-[0_8px_30px_rgba(221,39,39,0.35)]"
                                >
                                    Book Now
                                </Link>
                                <Link
                                    to="/contact"
                                    className="inline-block px-10 py-4 rounded-full font-bold uppercase tracking-wider transition-all duration-500 hover:-translate-y-1 bg-white/5 border border-white/15 text-white backdrop-blur-md"
                                >
                                    Contact Us
                                </Link>
                            </div>
