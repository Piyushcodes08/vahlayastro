...
const PremiumCourseLayout = ({ 
  ...
  return (
    <div className="min-h-screen bg-[#0a0101] text-white selection:bg-[#dd2727]/30 font-poppins overflow-x-hidden">
      <Header />
      ...
      <section className="relative min-h-[70vh] flex items-center pt-20 pb-32">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-1/4 -left-20 w-96 h-96 bg-[#dd2727]/10 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        <div className="relative z-10 premium-container flex flex-col lg:flex-row justify-between items-center gap-16 pt-[50px]">
          ...
          >
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md">
              <span className="flex text-[#dd2727] gap-0.5">
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="absolute -inset-4 bg-gradient-to-r from-[#dd2727]/30 to-[#b0a102]/30 rounded-[3rem] blur-3xl opacity-30 animate-pulse"></div>
            <div className="relative rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl aspect-[4/3] max-w-[500px] mx-auto lg:ml-auto">
              ...
              <div className="absolute bottom-8 left-8 right-8 p-6 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/10">
                <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#dd2727] mb-2">Sacred Mastery</p>
      ...
      <section className="relative z-10 -mt-20 px-6">
        <div className="premium-container grid grid-cols-1 md:grid-cols-4 gap-4 bg-[#150a0a]/90 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 shadow-2xl">
          {[
            ...
            <div key={i} className="flex items-center gap-4 p-4 rounded-2xl hover:bg-white/[0.03] transition-colors border border-transparent hover:border-white/5">
      ...
      <section className="py-32 px-6">
        <div className="premium-container flex flex-col lg:flex-row gap-24">
          <div className="flex-1 space-y-12">
            <div>
              <h2 className="title-batangas text-4xl md:text-5xl mb-8">Course <span className="text-[#dd2727]">Overview</span></h2>
          ...
          <div className="lg:w-[450px]">
            <div className="sticky top-32 space-y-8">
              <div className="p-10 rounded-[3rem] bg-gradient-to-br from-white/10 to-transparent border border-white/10 backdrop-blur-2xl relative overflow-hidden group">
                ...
                <Link to={enrollLink}>
                  <button className="w-full mt-10 py-4 rounded-xl bg-white text-black font-black uppercase tracking-[0.2em] text-xs hover:bg-[#dd2727] hover:text-white transition-all duration-500">
                    Get Started Today
                  </button>
                </Link>
              </div>
              ...
              <div className="relative rounded-[3rem] overflow-hidden border border-white/10 aspect-video group">
                ...
                <div className="absolute bottom-6 left-6">
                  <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#dd2727] mb-1">Guided By</p>
        ...
        <section className="py-32 px-6 bg-white/[0.02]">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-20">
              <h2 className="title-batangas text-4xl md:text-6xl mb-6">Course <span className="text-[#dd2727]">Curriculum</span></h2>
              <p className="text-white/40 uppercase tracking-[0.3em] text-xs font-black">Path to Enlightenment</p>
            </div>

            <div className="space-y-6">
              {curriculum.map((item, i) => (
                <div key={i} className="group p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-[#dd2727]/30 transition-all">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-6">
                      <span className="text-2xl font-black text-white/10 group-hover:text-[#dd2727]/50 transition-colors">0{i+1}</span>
      ...
      {faqs.length > 0 && (
        <section className="py-32 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-20">
              <h2 className="title-batangas text-4xl md:text-5xl mb-6 text-[#dd2727]">Common Inquiries</h2>
      ...
      <section className="py-32 px-6">
        <div className="premium-container p-12 md:p-20 rounded-[4rem] bg-gradient-to-br from-[#dd2727]/10 to-transparent border border-[#dd2727]/20 flex flex-col md:flex-row items-center gap-16 relative overflow-hidden">
          <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-[#dd2727]/5 rounded-full blur-[100px]"></div>
          <div className="flex-1 text-center md:text-left space-y-8 relative z-10">
            <h2 className="title-batangas text-4xl md:text-6xl">Vedic <span className="text-[#dd2727]">Certification</span></h2>
            ...
            <div className="flex items-center gap-6 justify-center md:justify-start">
              <div className="text-center">
                ...
                <p className="text-[10px] font-bold text-[#dd2727] uppercase tracking-widest">Verified</p>
              </div>
              <div className="w-[1px] h-10 bg-white/10"></div>
              <div className="text-center">
                <p className="text-3xl font-black text-white">Sharable</p>
                <p className="text-[10px] font-bold text-[#dd2727] uppercase tracking-widest">Digital ID</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-32 px-6">
        <div className="premium-container">
          <div className="text-center mb-20">
            <h2 className="title-batangas text-4xl md:text-6xl mb-6">Student <span className="text-[#dd2727]">Echoes</span></h2>
      ...
      <section className="py-40 text-center relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-radial-gradient from-[#dd2727]/10 to-transparent blur-[150px] opacity-50"></div>
        <div className="max-w-4xl mx-auto px-6 relative z-10 space-y-12">
          <h2 className="title-batangas text-5xl md:text-8xl leading-tight">Begin Your <br /><span className="text-[#dd2727]">Sacred Path</span></h2>
          ...
          <Link to={enrollLink}>
            <motion.button 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-16 py-6 rounded-full bg-[#dd2727] text-white font-black uppercase tracking-[0.4em] text-sm shadow-[0_20px_50px_rgba(221,39,39,0.5)] hover:bg-white hover:text-[#dd2727] transition-all duration-700"
            >
              Enroll Now
            </motion.button>
          </Link>
